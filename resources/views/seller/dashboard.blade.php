<x-app-layout>
    <div class="bg-gray-100 min-h-screen py-6 sm:py-10">
        <div class="max-w-7xl mx-auto px-3 sm:px-4 space-y-6 sm:space-y-8">

            <!-- HEADER -->
            <div class="mb-8">
                <h1 class="text-2xl sm:text-3xl font-bold">Seller Dashboard</h1>
                <p class="text-gray-500">Seller controls and tools</p>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow mb-4 mt-6">
                ...
                <div class="text-sm text-gray-500 mb-6 mt-6 flex flex-col sm:flex-row sm:flex-wrap gap-3">

                    <a href="{{ route('seller.store.edit') }}"
                       class="w-full sm:w-auto text-center px-4 py-2 bg-white text-black border border-black rounded-3xl hover:bg-blue-300 transition shadow-md">
                        Edit Store
                    </a>

                    <a href="{{ route('store.show', Auth::user()->sellerProfile->id) }}"
                       class="w-full sm:w-auto text-center px-4 py-2 bg-white text-black border border-black rounded-3xl hover:bg-green-400 transition shadow-md">
                        View Store
                    </a>

                    <a href="{{ route('seller.orders.index') }}"
                       class="w-full sm:w-auto text-center px-4 py-2 bg-white text-black border border-black rounded-3xl hover:bg-purple-300 transition shadow-md">
                        Order Management
                    </a>

                    <a href="{{ route('seller.products.index') }}"
                       class="w-full sm:w-auto text-center px-4 py-2 bg-white text-black border border-black rounded-3xl hover:bg-yellow-300 transition shadow-md">
                        Product Management
                    </a>

                    <a href="{{ route('seller.disputes.index') }}"
                       class="w-full sm:w-auto text-center px-4 py-2 bg-white text-black border border-black rounded-3xl hover:bg-red-400 transition shadow-md">
                        Disputes
                    </a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
                    ...
                    <p class="text-xs text-gray-500 mt-1">
                        Total Revenue reflects the revenue that you have made less funds in escrow
                    </p>
                </div>

                <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
                    <h3 class="text-sm text-gray-600">In Escrow</h3>
                    <p class="text-2xl font-bold text-black">
                        R{{ number_format($escrowBalance, 2) }}
                    </p>
                    <p class="text-xs text-gray-500 mt-1">
                        Funds held until orders have gone through moderation. Access Seller Guide for more information:
                    </p>
                    <a href="{{ route('seller.guide') }}" class="text-blue-600 text-xs underline">
                        Seller Guide
                    </a>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
                    ...
                    <p class="text-xs text-gray-500 mt-1">
                        This figure only records orders that are completed
                    </p>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow hover:shadow-md transition">
                    ...
                    <p class="text-xs text-gray-500 mt-1">
                        On average, how many orders does each product generate
                    </p>
                </div>
